...
//  created by me to add new schema for user creation by maanger
const registerSchemaForMember = yup.object({
  email: yup.string().email().required(),
  username: yup.string().required()
});
...
module.exports = {
  ...
  validateRegisterBodyForMember: validateYupSchema(registerSchemaForMember),
