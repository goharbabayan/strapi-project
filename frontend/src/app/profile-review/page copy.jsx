    ...
    <div className={`${styles.mainWrap} page-width`}>
      ...
      {requestType &&
        <Text
          tag={'h4'}
          className={styles.heading}
          children={requestType === 'data_change' ? 'The escort has made changes to her profile that require admin approval.' : 'The escort has requested for verification status level upgrade.'}
        />
      }
